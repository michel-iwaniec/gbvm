...
void adventure_init(void) BANKED {
    ...
    camera_offset_x_subpx = 0;
    camera_offset_y_subpx = 0;
    camera_deadzone_x_subpx = PX_TO_SUBPX(ADVENTURE_CAMERA_DEADZONE);
    camera_deadzone_y_subpx = PX_TO_SUBPX(ADVENTURE_CAMERA_DEADZONE);
}
