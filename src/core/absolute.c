...
#define SHADOW_OAM2_BASE_ADDRESS 0x0200
...
OAM_item_t      AT(SHADOW_OAM2_BASE_ADDRESS)                                           shadow_OAM2[MAX_HARDWARE_SPRITES];
check_size(shadow_OAM2, 4*MAX_HARDWARE_SPRITES);
