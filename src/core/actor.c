...
actor_t *actor_overlapping_bb(bounding_box_16_t *bb, upoint16_t *offset, actor_t *ignore, UBYTE inc_noclip) BANKED {
...
UWORD check_collision_in_direction(UWORD start_x, UWORD start_y, bounding_box_16_t *bounds, UWORD end_pos, col_check_dir_e check_dir) BANKED {
