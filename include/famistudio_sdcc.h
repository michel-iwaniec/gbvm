 ...
 *
 * HACK: Changed to NOT update APU registers - these are moved to famistudio_update_apu_regs instead
 * 
 * [in] no input params.
 * ======================================================================================================================
 */
...
/**
 * ======================================================================================================================
 * famistudio_update_apu_regs (public)
 * 
 * Applies any change to the APU registers. Applies changes done in famistudio_update
 * 
 * [in] no input params.
 * ======================================================================================================================
 */

void famistudio_update_apu_regs(void);
