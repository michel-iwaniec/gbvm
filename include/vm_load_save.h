...
void vm_save_clear(SCRIPT_CTX * THIS, UBYTE slot) OLDCALL BANKED REENTRANT;
...
void vm_save_peek(SCRIPT_CTX * THIS, INT16 idxA, INT16 idxB, INT16 idxC, UWORD count, UBYTE slot) OLDCALL BANKED REENTRANT;
