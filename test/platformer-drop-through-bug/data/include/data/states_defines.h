...
#define INPUT_PLATFORM_INTERACT          INPUT_UP
#define INPUT_PLATFORM_FORCE_TRIGGER     FALSE
...
#define INPUT_PLATFORM_DROP_THROUGH      DROP_THRU_INPUT_DOWN_HOLD
#define INPUT_PLATFORM_FLOAT             FLOAT_INPUT_HOLD_UP
